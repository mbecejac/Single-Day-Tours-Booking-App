...
@user_router.post("/add-new-user", response_model=UserSchema, dependencies=[Depends(JWTBearer(["superuser"]))])
...
@user_router.get(
    "/get-all-users", response_model=list[UserSchema], dependencies=[Depends(JWTBearer(["employee", "superuser"]))]
)
def get_all_users():
...
@user_router.get(
    "/get-user/email", response_model=UserSchema, dependencies=[Depends(JWTBearer(["employee", "superuser"]))]
)
def get_user_by_email(email: str):
    return UserController.get_user_by_email(email)


@user_router.put("/update/is-active", response_model=UserSchemaUpdate, dependencies=[Depends(JWTBearer(["superuser"]))])
...
@user_router.put(
    "/update/is-superuser", response_model=UserSchemaUpdate, dependencies=[Depends(JWTBearer(["superuser"]))]
)
...
@user_router.delete("/delete-user", dependencies=[Depends(JWTBearer(["superuser"]))])
...
@employee_router.post(
    "/add-new-employee", response_model=EmployeeSchema, dependencies=[Depends(JWTBearer(["superuser"]))]
)
...
@employee_router.get(
    ...
    dependencies=[Depends(JWTBearer(["employee", "superuser"]))],
)
...
@employee_router.get(
    "/get-employee/id", response_model=EmployeeSchema, dependencies=[Depends(JWTBearer(["employee", "superuser"]))]
)
...
@employee_router.get(
    "/get-employee/user-id", response_model=EmployeeSchema, dependencies=[Depends(JWTBearer(["employee", "superuser"]))]
)
def get_employee_by_user_id(user_id: str):
    return EmployeeController.get_employee_by_user_id(user_id)


@employee_router.delete("/delete-employee", dependencies=[Depends(JWTBearer(["superuser"]))])
...
@language_router.post(
    "/add-new-language", response_model=LanguageSchema, dependencies=[Depends(JWTBearer(["superuser"]))]
)
...
@language_router.get(
    ...
    dependencies=[Depends(JWTBearer(["superuser", "employee"]))],
)
...
@language_router.get(
    "/get-language-by-id", response_model=LanguageSchema, dependencies=[Depends(JWTBearer(["superuser", "employee"]))]
)
def get_language_by_id(language_id: str):
    return LanguageController.get_language_by_id(language_id)


@language_router.delete("/delete-language", dependencies=[Depends(JWTBearer(["superuser"]))])
...
@tour_guide_router.post(
    "/add-new-tour-guide", response_model=TourGuideSchema, dependencies=[Depends(JWTBearer(["superuser"]))]
)
...
@tour_guide_router.get(
    "/get-all-tour-guides",
    response_model=list[TourGuideSchema],
    dependencies=[Depends(JWTBearer(["superuser", "employee"]))],
)
...
@tour_guide_router.get(
    ...
    response_model=TourGuideSchema,
    dependencies=[Depends(JWTBearer(["superuser", "employee"]))],
)
...
@tour_guide_router.get(
    "/get-tour-guide-by-name-or-lastname",
    response_model=list[TourGuideSchema],
    dependencies=[Depends(JWTBearer(["superuser", "employee"]))],
)
...
@tour_guide_router.delete("/delete-tour-guide", dependencies=[Depends(JWTBearer(["superuser"]))])
...
@customer_router.post(
    "/add-new-customer", response_model=CustomerSchema, dependencies=[Depends(JWTBearer(["superuser"]))]
)
...
@customer_router.get(
    ...
    dependencies=[Depends(JWTBearer(["superuser", "employee", "tour_guide"]))],
...
@customer_router.get(
    "/get-customer-by-name-or-lastname",
    response_model=list[CustomerSchema],
    dependencies=[Depends(JWTBearer(["superuser", "employee", "tour_guide"]))],
)
...
@customer_router.post(
    "/update-customer-data", response_model=CustomerSchema, dependencies=[Depends(JWTBearer(["superuser"]))]
)
...
@customer_router.delete("/delete-customer", dependencies=[Depends(JWTBearer(["superuser"]))])
